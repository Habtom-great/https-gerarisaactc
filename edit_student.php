...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && hash_equals($_SESSION['csrf_token'], $_POST['csrf_token'])) {
    ...
    if ($uploadOk) {
        try {
            $stmt = $pdo->prepare("UPDATE students SET first_name = ?, middle_name = ?, last_name = ?, email = ?, telephone = ?, role = ?, profile_image = ?, address = ? WHERE id = ?");
            $stmt->execute([
                $_POST['first_name'],
                $_POST['middle_name'],
                $_POST['last_name'],
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="phone" name="phone" class="form-control" value="<?= htmlspecialchars($user['telephone']) ?>" required>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select id="role" name="role" class="form-control">
                        ...
                        <option value="user" <?= $user['role'] === 'user' ? 'selected' : '' ?>>Other</option>
                    </select>
                </div>
                <div class="form-group col-md-6">
